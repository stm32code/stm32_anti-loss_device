...
void W_Test(void)
{
  System_WriteInteriorFlash(addrShort1, (uint8_t *)&longitude_sum, sizeof(longitude_sum));
	System_WriteInteriorFlash(addrShort2, (uint8_t *)&latitude_sum, sizeof(latitude_sum));
}
// 读取数据
void R_Test(void)
{
	 System_ReadInteriorFlash(addrShort1, (uint8_t *)&longitude_sum, sizeof(longitude_sum));
   System_ReadInteriorFlash(addrShort2, (uint8_t *)&latitude_sum, sizeof(latitude_sum));
}
/*********************************************************************************
